...
echo "<td class='text-center'  >".$row["newsCategory"]."</td>";
echo "<td class='text-center'>

					 

<a title='Edit News' href='".site_url('IndexCtrl/edit/'.$row["_id"])."' class='tooltip-default' data-rel='tooltip' data-placement='top'>
<i class='fa fa-edit' ></i>
</a> &nbsp; | &nbsp;


<a title='Delete News' onClick='return doconfirm();' href='".site_url('IndexCtrl/deleteFn/'.$row["_id"])."' class='tooltip-default' data-rel='tooltip' data-placement='top'>
